...
data = pd.read_csv("../results_disused/euler_q_complex_n4.csv", encoding="utf-8")

thetas, norms = 2048, 1024
...
theta = theta.reshape(thetas, norms) * np.pi
norm  = norm.reshape(thetas, norms)
y  = y.reshape(thetas, norms)
v  = v.reshape(thetas, norms)
